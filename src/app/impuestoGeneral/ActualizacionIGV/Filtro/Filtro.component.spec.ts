...
import { ActualizacionIGVComponent } from './Filtro.component';

describe('AppComponent', () => {
  beforeEach(() => TestBed.configureTestingModule({
    imports: [RouterTestingModule],
    declarations: [ActualizacionIGVComponent]
  }));

  it('should create the app', () => {
    const fixture = TestBed.createComponent(ActualizacionIGVComponent);
